...
re_analysis = false; % swith to ture to re run all main analysis
...
if re_analysis
    ...
    for gl = 1:2
        ...
        rel_sigmas = f012_fitsigmoid([reward_list, mean_rel_value']);
        x = -9.7:0.1:9.7;
        ...
        irrel_sigmas = f012_fitsigmoid([reward_list, mean_irrel_value']);
